...
life1 = read.csv("datasets/life-expectancy-1959-1978.csv")
life2 = read.csv("datasets/life-expectancy-1979-1998.csv")
life3 = read.csv("datasets/life-expectancy-1999-2016.csv")
life4 = read.csv("datasets/cdc-life-expectancy-2018-2020.csv")
